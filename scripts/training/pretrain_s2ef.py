...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--project", type=str, default="AtomGen", help="Name of the wandb project"
    )
    parser.add_argument(
        "--name",
        type=str,
        default="s2ef_15m_train_base_10epochs",
    ...
    parser.add_argument(
        "--model_config",
        type=str,
        default="atomgen/models/configs/atomformer-base.json",
        help="Path to the model config",
    )
    parser.add_argument(
        "--tokenizer_json",
        type=str,
        default="atomgen/data/tokenizer.json",
    ...
    parser.add_argument(
        "--macro_batch_size", type=int, default=128, help="Macro batch size"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--max_grad_norm", type=float, default=5.0, help="Maximum gradient norm"
    )
    parser.add_argument(
        "--eval_accum_steps",
        type=int,
        default=1000,
        help="Number of eval steps to accumulate",
    )
    parser.add_argument(
        "--save_steps", type=int, default=3000, help="Number of steps to save the model"
    )
    parser.add_argument(
        "--log_steps", type=int, default=150, help="Number of steps to log the training"
    )
    parser.add_argument(
        "--learning_rate", type=float, default=3e-4, help="Learning rate"
    )
    parser.add_argument(
        "--num_cpus", type=int, default=-1, help="Number of cpus available"
    )
    parser.add_argument(
        "--save_total_limit",
        type=int,
    ...
    parser.add_argument(
        "--group_by_length",
        action=argparse.BooleanOptionalAction,
        help="Whether to group samples by length",
    )
    parser.add_argument(
        "--length_column_name",
        type=str,
