...
def main(args):
    ...
    with Pool(num_processes) as pool:
        for _ in tqdm(pool.imap_unordered(lambda x: process_data(x, args.output_dir), chunks), total=len(chunks)):
            pass
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Preprocess ODAC23 dataset into a HuggingFace dataset.')
